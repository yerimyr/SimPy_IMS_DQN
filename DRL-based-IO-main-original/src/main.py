...
def build_model():
    if RL_ALGORITHM == "DQN":
        model = DQN("MlpPolicy", env, verbose=0, learning_rate=0.0001, batch_size=20, gamma=0.99)
        ...
        model = PPO("MlpPolicy", env, verbose=0, learning_rate=0.00005,batch_size=512,n_steps=SIM_TIME, device = device)
